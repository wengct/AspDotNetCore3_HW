...
namespace HW01.Migrations
{
    ...
    [Migration("20200518175104_DateModified")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HW01.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HW01.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("HW01.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("HW01.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HW01.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("HW01.Models.Course", b =>
                {
                    b.HasOne("HW01.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("HW01.Models.CourseInstructor", b =>
                {
                    b.HasOne("HW01.Models.Course", "Course")
                    ...
                    b.HasOne("HW01.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("HW01.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("HW01.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("HW01.Models.OfficeAssignment", b =>
                {
                    b.HasOne("HW01.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("HW01.Models.OfficeAssignment", "InstructorId")
